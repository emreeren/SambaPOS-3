...
namespace Samba.Presentation.ViewModels
{
    public class AccountViewModel : ObservableObject
    {
        ...
        public IEnumerable<OrderViewModel> LastTicketLines { get { return LastTicket != null ? LastTicket.Orders.Where(x => !x.Gifted || !x.Voided).Select(x => new OrderViewModel(x)) : null; } }
