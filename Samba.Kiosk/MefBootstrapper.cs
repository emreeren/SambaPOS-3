...
namespace Samba.Kiosk
{
    ...
    public static class MefBootstrapper
    {
        ...
        static MefBootstrapper()
        {
            ...
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Samba.Modules.EntityModule.dll"));
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Samba.Modules.SettingsModule.dll"));
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Samba.Modules.AutomationModule.dll"));
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Samba.Modules.TicketModule.dll"));
            catalog.Catalogs.Add(new DirectoryCatalog(path, "Samba.Modules.TaskModule.dll"));
