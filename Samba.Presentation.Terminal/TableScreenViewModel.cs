...
namespace Samba.Presentation.Terminal
{
    ...
    public class TableScreenViewModel : ObservableObject
    {
        ...
        {
            Tables.Clear();
            Tables.AddRange(AppServices.DataAccessService.GetCurrentTables(AppServices.MainDataContext.SelectedDepartment.TerminalTableScreens.FirstOrDefault().Id, CurrentPageNo)
