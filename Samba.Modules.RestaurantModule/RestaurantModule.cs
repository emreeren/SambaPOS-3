...
{
    [ModuleExport(typeof(RestaurantModule))]
    public class RestaurantModule : VisibleModuleBase
    {
        private readonly IRegionManager _regionManager;
        private readonly TableSelectorView _tableSelectorView;

        [ImportingConstructor]
        public RestaurantModule(IRegionManager regionManager, TableSelectorView tableSelectorView)
